<script lang="ts">
  ...
  const installCode = `npm install @ldesign/router-sveltekit
# 或
...
<div class="page about-page">
  <h2>📖 关于 @ldesign/router-sveltekit</h2>
  
  <div class="content">
    <section class="section">
      <h3>项目简介</h3>
      <p>
        @ldesign/router-sveltekit 是一个专为 Svelte 5 设计的现代化路由解决方案。
        它基于 @ldesign/router-core 核心库，提供了符合 Svelte 生态的 API 和组件。
      </p>
    </section>
    ...
    <section class="section">
      ...
      <ul class="features-list">
        <li>✨ 完整的 Svelte 5 Runes 支持</li>
        <li>🔧 强大的路由钩子和守卫</li>
        <li>📱 动态路由和嵌套路由</li>
        <li>🎨 内置的 RouterLink 和 RouterView 组件</li>
        <li>⚡ 轻量级，无额外依赖</li>
    ...
    <section class="section">
      ...
      <div class="info-grid">
        ...
        <div class="info-item">
          ...
          <code>{currentRoute.name || 'N/A'}</code>
        </div>
        <div class="info-item">
