  ...
  <div class="user-page">
    <div class="page-header">
      ...
      <div class="user-actions">
        <button @click="refreshUser" class="btn btn-outline" :disabled="loading">
      ...
      <div class="user-details">
        ...
        <div class="permissions-card">
          ...
          <div class="permissions-list">
            <div class="permission-group" v-for="group in userPermissions" :key="group.name">
      ...
      <div class="user-activity">
        <div class="activity-card">
          ...
          <div class="activity-list">
            <div class="activity-item" v-for="activity in userActivity" :key="activity.id">
              <div class="activity-icon">{{ activity.icon }}</div>
              <div class="activity-content">
                <div class="activity-title">{{ t(`user.activity.types.${activity.type}`) }}</div>
        ...
        <div class="stats-card">
          ...
          <div class="stats-grid">
            <div class="stat-item">
              ...
              <div class="stat-label">{{ t('user.stats.logins') }}</div>
            </div>
            <div class="stat-item">
              <div class="stat-value">{{ userStats.projectCount }}</div>
              <div class="stat-label">{{ t('user.stats.projects') }}</div>
            </div>
            <div class="stat-item">
              <div class="stat-value">{{ userStats.taskCount }}</div>
              <div class="stat-label">{{ t('user.stats.tasks') }}</div>
            </div>
            <div class="stat-item">
              <div class="stat-value">{{ userStats.score }}</div>
              <div class="stat-label">{{ t('user.stats.score') }}</div>
            </div>
          </div>
        </div>
          ...
          <div class="preferences-list">
            <div class="preference-item">
              ...
              <select v-model="userPreferences.theme" @change="updateTheme">
                <option value="light">{{ t('user.preferences.themes.light') }}</option>
                <option value="dark">{{ t('user.preferences.themes.dark') }}</option>
                <option value="auto">{{ t('user.preferences.themes.auto') }}</option>
              </select>
            </div>
            <div class="preference-item">
...
const loadUserData = async () => {
  ...
  try {
    ...
    const userIndex = parseInt(userId.value) % names.length
