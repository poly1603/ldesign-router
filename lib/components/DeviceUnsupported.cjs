...
var DeviceUnsupported = vue.defineComponent({
  ...
  setup(props) {
    ...
    const supportedDeviceNames = vue.computed(() => {
    ...
    return () => vue.h("div", {
      ...
      vue.h("div", {
        ...
        }, [vue.h("p", {}, [vue.h("strong", {}, "\u5F53\u524D\u8BBE\u5907\uFF1A"), vue.h("span", {
          class: "device-unsupported__current-device"
        }, currentDeviceName.value)]), props.supportedDevices.length > 0 ? vue.h("p", {}, [vue.h("strong", {}, "\u652F\u6301\u7684\u8BBE\u5907\uFF1A"), vue.h("span", {
          class: "device-unsupported__supported-devices"
        }, supportedDeviceNames.value.join("\u3001"))]) : null]),
        // 建议
        vue.h("div", {
          class: "device-unsupported__suggestions"
        }, [vue.h("h3", {}, "\u5EFA\u8BAE\uFF1A"), vue.h("ul", {}, [props.supportedDevices.includes("desktop") ? vue.h("li", {}, "\u8BF7\u4F7F\u7528\u684C\u9762\u7535\u8111\u6216\u7B14\u8BB0\u672C\u7535\u8111\u8BBF\u95EE") : null, props.supportedDevices.includes("tablet") ? vue.h("li", {}, "\u8BF7\u4F7F\u7528\u5E73\u677F\u8BBE\u5907\u8BBF\u95EE") : null, props.supportedDevices.includes("mobile") ? vue.h("li", {}, "\u8BF7\u4F7F\u7528\u624B\u673A\u8BBF\u95EE") : null, vue.h("li", {}, "\u8054\u7CFB\u7BA1\u7406\u5458\u83B7\u53D6\u66F4\u591A\u5E2E\u52A9")].filter(Boolean))])
      ]),
      // 操作按钮
      vue.h("div", {
        class: "device-unsupported__actions"
      }, [props.showBackButton ? vue.h("button", {
        type: "button",
        class: "device-unsupported__button device-unsupported__button--secondary",
        onClick: goBack
      }, "\u8FD4\u56DE\u4E0A\u4E00\u9875") : null, props.showRefreshButton ? vue.h("button", {
        type: "button",
        class: "device-unsupported__button device-unsupported__button--primary",
        onClick: refresh
      }, "\u5237\u65B0\u9875\u9762") : null].filter(Boolean)),
      // 来源信息
      props.from ? vue.h("div", {
        class: "device-unsupported__from"
      }, [vue.h("small", {}, ["\u6765\u6E90\u9875\u9762\uFF1A", props.from])]) : null
    ])]);
  }
});

exports.default = DeviceUnsupported;
/*! End of @ldesign/router | Powered by @ldesign/builder */
//# sourceMappingURL=DeviceUnsupported.cjs.map
