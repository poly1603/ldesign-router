  ...
  static async preload(route, router) {
    ...
    const preloadPromise = (async () => {
      try {
        ...
        logger.logger.warn("\u9884\u52A0\u8F7D\u5931\u8D25:", error);
      } finally {
...
const RouterLinkEnhanced = vue.defineComponent({
  ...
  setup(props, {
    ...
    const currentRoute = index.useRoute();
    const linkRef = vue.ref();
    const isNavigating = vue.ref(false);
    const prefetchTimer = vue.ref();
    const targetLocation = vue.computed(() => {
    ...
    return () => {
      ...
      if (props.transition && !isExternal.value) {
        return vue.h(vue.Transition, typeof props.transition === "string" ? {
          name: props.transition
        } : props.transition, () => vue.h(props.tag, linkProps, content));
      }
      return vue.h(props.tag, linkProps, content);
    };
  }
});

exports.RouterLinkEnhanced = RouterLinkEnhanced;
exports.default = RouterLinkEnhanced;
/*! End of @ldesign/router | Powered by @ldesign/builder */
//# sourceMappingURL=RouterLinkEnhanced.cjs.map
