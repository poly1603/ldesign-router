...
var vue = require('vue');
var index = require('../features/i18n/index.cjs');
var RouterLink = require('./RouterLink.cjs');

const LocaleSwitcher = vue.defineComponent({
  name: "LocaleSwitcher",
  props: {
    // 显示模式
    mode: {
  ...
  setup(props, {
    ...
    const renderDropdown = () => {
      ...
      }) || vue.h("span", formatLocale(locale.value)), vue.h("svg", {
      ...
      }, [props.format === "emoji" && vue.h("span", {
        class: "locale-switcher__emoji"
      }, props.emojis[link.locale]), vue.h("span", formatLocale(link.locale))])])))]);
    };
    const renderInline = () => {
      const links = getSwitchLinks();
      return vue.h("nav", {
      ...
      }, links.map((link, index) => vue.h("li", {
        key: link.locale,
        class: "locale-switcher__item"
      }, [vue.h(RouterLink.RouterLink, {
        to: link.path,
        class: ["locale-switcher__link", {
          "locale-switcher__link--active": link.active
        }],
      ...
      }), index < links.length - 1 && vue.h("span", {
...
//# sourceMappingURL=LocaleSwitcher.cjs.map
