...
const OPTIMIZED_CACHE_CONFIG = {
  ...
  strategy: constants.CacheStrategy.MEMORY,
  /** 最大缓存项数量 */
  maxItems: 50,
  /** 缓存过期时间（毫秒） */
  ttl: 5 * 60 * 1e3,
...
const OPTIMIZED_PRELOAD_CONFIG = {
  ...
  enabled: true,
  /** 预加载策略 */
  strategy: constants.PreloadStrategy.IDLE,
  /** 最大并发预加载数 - 从 5 降低到 2 */
  maxConcurrent: 2,
...
const OPTIMIZED_ANIMATION_CONFIG = {
  ...
  enabled: true,
  /** 默认动画类型 */
  defaultAnimation: constants.AnimationType.FADE,
...
const DEV_CONFIG = {
  /** 是否启用调试模式 */
  debug: typeof ({ url: (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('config/performance-defaults.cjs', document.baseURI).href)) }) !== "undefined" && undefined?.DEV || false,
  /** 是否启用性能分析 */
  profiling: false,
  /** 是否启用详细日志 */
...
exports.MEMORY_MONITOR_CONFIG = MEMORY_MONITOR_CONFIG;
exports.OPTIMIZED_ANIMATION_CONFIG = OPTIMIZED_ANIMATION_CONFIG;
exports.OPTIMIZED_CACHE_CONFIG = OPTIMIZED_CACHE_CONFIG;
exports.OPTIMIZED_MEMORY_THRESHOLDS = OPTIMIZED_MEMORY_THRESHOLDS;
exports.OPTIMIZED_PERFORMANCE_CONFIG = OPTIMIZED_PERFORMANCE_CONFIG;
exports.OPTIMIZED_PRELOAD_CONFIG = OPTIMIZED_PRELOAD_CONFIG;
exports.OPTIMIZED_ROUTER_CONFIG = OPTIMIZED_ROUTER_CONFIG;
exports.PERFORMANCE_TIPS = PERFORMANCE_TIPS;
exports.PROD_CONFIG = PROD_CONFIG;
exports.default = performanceDefaults;
exports.getOptimizedConfig = getOptimizedConfig;
/*! End of @ldesign/router | Powered by @ldesign/builder */
//# sourceMappingURL=performance-defaults.cjs.map
