...
var optimizedTrie = require('./matcher/optimized-trie.cjs');
...
class RouterEventBus extends EventTarget {
  constructor() {
    ...
    this.eventPool = new optimizedTrie.ObjectPool(() => new CustomEvent("router", {
      detail: {}
    }), (event) => {
...
class GuardExecutor {
  constructor() {
    ...
    this.stringPool = new optimizedTrie.StringPool();
  }
...
class OptimizedRouter {
  constructor(_options) {
    ...
    this.locationPool = new optimizedTrie.ObjectPool(() => ({
      path: "",
      name: void 0,
      params: {},
      query: {},
...
//# sourceMappingURL=optimized-router.cjs.map
