...
function useMicroFrontend() {
  const microRouter = vue.inject("microRouter");
  if (!microRouter) {
...
exports.MicroFrontendPlugin = MicroFrontendPlugin;
exports.MicroFrontendRouter = MicroFrontendRouter;
exports.useMicroFrontend = useMicroFrontend;
