 ...
 * ***********************************
 */
import { createDeviceDetector } from './es/index.js';
import { DeviceRouteGuard } from './guard.js';
import { DeviceComponentResolver } from './resolver.js';
...
class DeviceRouterPlugin {
  constructor(router, options = {}) {
    ...
    this.componentResolver = new DeviceComponentResolver(() => this.deviceDetector.detectDeviceType());
    this.deviceGuard = new DeviceRouteGuard(() => this.deviceDetector.detectDeviceType(), this.options.guardOptions);
  }
  /**
   * 安装插件
   */
...
export { DeviceRouterPlugin, createDeviceRouterPlugin };
