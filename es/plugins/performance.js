...
class PerformanceManager {
  ...
  calculateMetrics(navigation) {
    ...
    const componentLoadStart = events.find((e) => e.type === PerformanceEventType.COMPONENT_LOAD_START);
    const componentLoadEnd = events.find((e) => e.type === PerformanceEventType.COMPONENT_LOAD_END);
    const routeMatchStart = events.find((e) => e.type === PerformanceEventType.ROUTE_MATCH_START);
    const routeMatchEnd = events.find((e) => e.type === PerformanceEventType.ROUTE_MATCH_END);
    const guardStart = events.find((e) => e.type === PerformanceEventType.GUARD_EXECUTION_START);
    const guardEnd = events.find((e) => e.type === PerformanceEventType.GUARD_EXECUTION_END);
    return {
...
export { PerformanceEventType, PerformanceManager, createPerformanceConfig, createPerformancePlugin, performance$1 as default, getPagePerformance, supportsPerformanceAPI, withPerformanceMonitoring };
