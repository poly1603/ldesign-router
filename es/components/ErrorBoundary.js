 ...
 * ***********************************
 */
import { defineComponent, ref, h, onErrorCaptured } from 'vue';
...
const DefaultErrorComponent = defineComponent({
  ...
  setup(props) {
    ...
    return () => h("div", {
      ...
      class: "error-message"
    }, getErrorMessage(props.error)), h("div", {
      class: "error-actions"
    }, [h("button", {
      class: "retry-button",
      onClick: props.onRetry
    }, "\u91CD\u8BD5"), props.showDetails && h("button", {
      class: "details-button",
      onClick: toggleDetails
    }, isDetailsVisible.value ? "\u9690\u85CF\u8BE6\u60C5" : "\u663E\u793A\u8BE6\u60C5")]), props.showDetails && isDetailsVisible.value && h("div", {
      class: "error-details"
    }, [h("pre", {
      class: "error-stack"
    }, props.error.stack || props.error.error.stack), h("div", {
      class: "error-meta"
    }, [h("p", `\u8DEF\u7531: ${props.error.route}`), h("p", `\u65F6\u95F4: ${new Date(props.error.timestamp).toLocaleString()}`), h("p", `\u7C7B\u578B: ${props.error.type}`)])])])]);
  }
});
const ErrorBoundary = defineComponent({
  ...
  props: {
    ...
    showDetails: {
      type: Boolean,
      default: typeof import.meta !== "undefined" && import.meta.env?.DEV || false
    },
    retryDelay: {
      type: Number,
      default: 1e3
...
export { ErrorBoundary, ErrorRecoveryStrategies, RouteErrorHandler, ErrorBoundary as default, withErrorBoundary };
