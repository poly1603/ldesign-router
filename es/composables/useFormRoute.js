...
import { FormRouteManager } from '../managers/FormRouteManager.js';

function useFormRoute(options = {}) {
  const manager = inject("formRouteManager", new FormRouteManager());
  ...
  const touched = computed(() => form.value?.touched ?? /* @__PURE__ */ new Set());
...
export { FormRoutePlugin, useFormField, useFormRoute, useMultiStepForm, validators };
/*! End of @ldesign/router | Powered by @ldesign/builder */
//# sourceMappingURL=useFormRoute.js.map
