...
import { RouteTypeGenerator } from './RouteTypeGenerator.js';
...
program.name("route-type-gen").description("Generate TypeScript types for Vue Router routes").version("1.0.0");
...
program.command("clean").description("Clean generated files").option("-o, --output-dir <path>", "Output directory", "./src/types").option("-f, --output-file <name>", "Output file name", "route-types.ts").action((options) => {
  try {
...
program.command("init").description("Initialize configuration file").option("-t, --type <type>", "Config file type (js, ts, json)", "js").action((options) => {
  const configContent = {
    js: `/**
 * \u8DEF\u7531\u7C7B\u578B\u751F\u6210\u5668\u914D\u7F6E\u6587\u4EF6
